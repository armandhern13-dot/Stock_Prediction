...
# ====== IMPORTANT: Update features to match YOUR training ======
# If you trained to predict UBER_Future using SBUX, NKE, CMG + macro features:
MODEL_INFO = {
    "endpoint": aws_endpoint,
    "explainer": "explainer.shap",
    "pipeline": "finalized_model.tar.gz",
    # ORDER MUST MATCH TRAINING (X.columns)
...
def call_model_api(input_df: pd.DataFrame):
    ...
    try:
        ...
        pred_val = float(np.asarray(raw_pred).ravel()[0])
